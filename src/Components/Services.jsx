...
export default function Services() {
  return (
    <div
      id="Services"
      className="min-h-screen flex-center flex-col  p-10 py-24 gap-5 bg-purple-50"
    >
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
        {services.map((service, index) => {
          return (
            ...
            >
              <div className="w-12 h-12 bg-purple-100 rounded-lg flex-center mb-4 text-purple-600 group-hover:bg-purple-600 group-hover:text-white transition-colors">
                <service.icon />
              </div>
