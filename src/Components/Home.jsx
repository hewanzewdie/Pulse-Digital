    ...
    >
      <div className="flex flex-col space-y-5 p-5">
        ...
        <div className="md:space-x-5 flex sm:flex-col md:flex-row sm:gap-5">
          <button className="lg:w-40 md:w-1/2 hover:shadow-xl bg-purple-700 border border-purple-700 text-white hover:bg-purple-800 rounded-xl py-3 flex justify-center">
            Get Started
            <ArrowRightIcon />{" "}
          </button>
          <button className="lg:w-40 md:w-1/2 hover:shadow-xl border border-purple-700 text-purple-700 hover:bg-purple-700 hover:text-white rounded-xl py-3">
            Learn More
          </button>
        </div>
      </div>
